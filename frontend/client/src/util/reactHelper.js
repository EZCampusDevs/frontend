...
//Stuff that's used in lots of components that and use JSX/React

//For building general Icons
export function iconBuilder (icon, str) {
...
export function profIcon(str) {
    return iconBuilder(<svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-6 h-6">
...
export function classTypeIcon (str) {
    str = str.trim();
